...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Xuyadongfight/podLibTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Xuyadongfight' => '13986885114@163.com' }
  s.source           = { :git => 'https://github.com/Xuyadongfight/podLibTest.git', :tag => s.version.to_s }
